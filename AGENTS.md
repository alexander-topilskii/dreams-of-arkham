...
- For each widget add description widgets/widget-name/README.md: what it do, how to use, API (input/output), when to destroy, how it looks and behaves for the user etc. 