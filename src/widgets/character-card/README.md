...
- При уменьшении здоровья карточка здоровья на секунду окрашивается в красный оттенок, резко трясётся, выбрасывает красные частички и показывает всплывающий текст `-X` с величиной потери.
