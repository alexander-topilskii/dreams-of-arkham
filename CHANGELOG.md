[2025-11-15 10:06][CHANGE] Переработал оформление карт руки под стиль настольной карты с артами, типом, тегами и футером.<br>
[2025-11-15 07:30][FIX] Сделал кнопку карты руки адаптивной по высоте вместо фиксированного значения.<br>
[2025-11-15 07:05][CHANGE] Ограничил обёртку карты руки авто-шириной 280px и запретил растягивание по flex.<br>
[2025-11-15 06:50][FIX] Ограничил обёртку и кнопку карты руки размерами самой карточки, чтобы убрать лишнее пустое пространство.<br>
